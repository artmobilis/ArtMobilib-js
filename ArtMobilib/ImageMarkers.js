...
var ImageMarkers = function (image) {
    ...
    IMload_image = function (name) {
        ...
        img.onload = function () {
            ...
            IMtrainpattern(mtrained_8u); // le pattern doit etre plus grand que 512*512 dans au moins une dimension (sinon pas de rescale et rien ne se passe)
        }
        img.src = name;
    };
